...
namespace WeatherAppCore.Controllers
{
    public class WeatherController : Controller
    {
        ...
        public ViewResult Index(string sortOrder, string currentFilter, string searchString, int? page, string searchString0, string searchString1)
        {
            ...
            ViewBag.CurrentFilter0 = !String.IsNullOrWhiteSpace(searchString0) ? searchString0 : "2012 - 06 - 01";
            ViewBag.CurrentFilter1 = !String.IsNullOrWhiteSpace(searchString1) ? searchString1 : "2012-06-01";
